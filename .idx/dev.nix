...
{ pkgs, ... }: {
  ...
  idx = {
    ...
    workspace = {
      ...
      onCreate = {
        build-flutter = ''
          cd /home/user/myapp/android # Caminho correto para a pasta android
          ./gradlew \
            --parallel \
            -Pverbose=true \
            -Ptarget-platform=android-x86 \
            -Ptarget=/home/user/myapp/lib/main.dart # Caminho correto para o main.dart
          ...
          cd /home/user/myapp # Caminho correto para a raiz do projeto
