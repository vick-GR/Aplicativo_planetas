...
class _TelaPlanetaState extends State<TelaPlaneta> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.of(context).pop(); // Navigator.of(context).pop(): Retorna para a tela anterior.
      widget.onFinalizado();
    }
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                TextFormField(   // TextFormField: cria o formulario para entrada de texto
                  controller: _tamanhoController,
                  decoration:
                      const InputDecoration(labelText: 'Tamanho (em km)'),
                  keyboardType: TextInputType.number,
                  autovalidateMode: AutovalidateMode.onUserInteraction, // Faz com que o campo valide seus dados a cada interação do usuario
                  validator: (value) {
                ...
                Row( //Row: Cria uma linha horizontal para colocar os botões lado a lado.
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly, //  Distribui os botões igualmente na linha, deixando espaços iguais entre eles.
                  children: [ // children:: Define os filhos do Row
                    ElevatedButton(
                      onPressed: () => Navigator.of(context).pop(), //Quando clicado, volta para a tela anterior.
