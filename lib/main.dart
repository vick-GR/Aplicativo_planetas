...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Planetas',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 200, 10, 80)),
        useMaterial3: true,
      ),
              ...
              trailing: Row(
                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () => _alterarPlaneta(context, planeta), // onPressed:define oque acontece quando o botão é pressionado.
                  ),
                  IconButton(
